...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff27d9a0);
  static const Color secondary = Color(0xff0e1b72);
  ...
  static const Color grad1Color = Color(0xff27d9a0);
  static const Color grad2Color = Color(0xff27d9b0);
